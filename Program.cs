...
public class Program
{
    static void Main(string[] args)
    {
        ...
        // arithmetic.Add(4, 5);
        // arithmetic.Subtract(54, 23);
        // arithmetic.Multiply(12, 3);
        // arithmetic.Divide(86, 2);
        // // Print a message indicating the end of the program
        // Console.WriteLine("Arithmetic operations completed.");
        ...
        // // Prompt for enter radius of circle
